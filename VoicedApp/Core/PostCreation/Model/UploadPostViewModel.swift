...
//   creates data -> creates uiImage -> which generates the swiftUI image
    ...
    func uploadPost(title: String, caption: String, category: PostCategory) async throws {
        ...
        let post = Post(id: postRef.documentID, ownerUid: uid, title: title, caption: caption, likes: 0, dislikes: 0, imageUrl: imageUrl, timestamp: Timestamp(), category: PostCategory(rawValue: category.rawValue) ?? PostCategory.miscellaneous)
